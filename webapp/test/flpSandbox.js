		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "DynamicPageApplication",
									"targetURL": "#nsdynamicpagedemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsdynamicpagedemo-display": {
								"semanticObject": "nsdynamicpagedemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.dynamicpagedemo",
									"url": sap.ui.require.toUrl("ns/dynamicpagedemo")
								}
							}
						}
					}
